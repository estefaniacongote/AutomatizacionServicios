...
@Slf4j
public class ConsultarOrdenGet implements Interaction {
    ...
    public ConsultarOrdenGet(EnvironmentVariables environmentVariables, String request, String typeContent) {
    ...
    public <T extends Actor> void performAs(T actor) {
        String baseUrl = EnvironmentSpecificConfiguration.from(environmentVariables)
                .getProperty("restapi.default.baseurl2"); // Asegúrate de que esta propiedad exista
    ...
    public static ConsultarOrdenGet params(EnvironmentVariables environmentVariables) {
        return Tasks.instrumented(ConsultarOrdenGet.class, environmentVariables);
    }
}
